...
void idt_init(void) {
     ...
     * tools/vector.c (try "make" command in lab1, then you will find vector.S
     * in kern/trap DIR) You can use  "extern uintptr_t __vectors[];" to define
     ...
     * idt[256] in this file? Yes, it's IDT! you can use SETGATE macro to setup
     * each item of IDT (3) After setup the contents of IDT, you will let CPU
     * know where is the IDT by using 'lidt' instruction. You don't know the
...
static void trap_dispatch(struct trapframe* tf) {
    ...
    then you can add code here.
             ...
             * global variable (increase it), such as ticks in
             * kern/driver/clock.c (2) Every TICK_NUM cycle, you can print some
             * info using a funciton, such as print_ticks(). (3) Too Simple?
             * Yes, I think so!
             */
            /* LAB5 YOUR CODE */
